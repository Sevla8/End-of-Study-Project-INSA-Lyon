...
\begin{encadrants}
	...
	\referent{Référent}{Cédric \Nom{Pradalier}}{Professeur}{Georgia Tech Europe}
...
\begin{document}
	...
	\section{Introduction.}
		...
		\INFO{L'introduction présente le contexte du projet, la définition du problème, un aperçu des contributions, et le plan du rapport.}

		\INFO{Le présent document a pour vocation d'illustrer le style de présentation que vous devez suivre pour votre rapport (quel que soit l’outil d’édition que vous utilisez) et de présenter quelques-unes des possibilités du style latex correspondant. À vous d'adapter le contenu à vos besoins. Par exemple, ce n'est pas parce que le style permet d'écrire une définition formelle, un théorème ou un lemme, et que le présent document l’illustre, que vous devez vous sentir obligé d'en écrire.}

		\INFO{La suite de ce rapport est principalement constituée de teste généré aléatoirement grâce à l'outil \url{http://enneagon.org/phrases}.}

		\TODO{Contexte,}

		\TODO{définition du problème,}

		\TODO{aperçu des contributions,}

		\TODO{plan du rapport}
